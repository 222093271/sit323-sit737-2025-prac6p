...
By simply switching to a more modern and minimal base image (node:23-slim), we improved our image security and reliability without sacrificing performance or functionality.
